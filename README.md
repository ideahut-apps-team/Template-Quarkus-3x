...
### Untuk menggunakan versi Quarkus tertentu:
...
* Edit file __pom.xml__ dengan mengubah versi __'quarkus.platform.version'__ sesuai dengan versi yang diinginkan.
    ...
    <properties>
        ...
        <quarkus.platform.version>3.38.0</quarkus.platform.version> <!-- Ubah bagian ini -->
...
* Ubah properties __'quarkus.profile'__ di __application.yaml__ sesuai dengan database yang diinginkan.
    ```yaml
    quarkus:
        #profile: 'db2'
        #profile: 'h2'
...
### Mode Development
* Untuk menjalankan aplikasi dalam mode development (_hot reload_). Ganti __'{profile}'__ dengan database yang digunakan.
    ```shell
